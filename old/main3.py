...
from funkcje import clean_data, draw_sample_value_plot, calculate_statistics, match_length, fill_with_last_valid, draw_sample_value_plot_cast,draw_histogram,fill_with_mean, remove_outliers
...
T1_proba1=fill_with_mean(T1_proba1)
T2_proba1=fill_with_mean(T2_proba1)
T1_proba2=fill_with_mean(T1_proba2)
T2_proba2=fill_with_mean(T2_proba2)
T1_proba3=fill_with_mean(T1_proba3)
T2_proba3=fill_with_mean(T2_proba3)
...
print("Dodaje wartosc srednia w puste miejsca")
...
draw_sample_value_plot((T1_proba1), 'Zależność T1_proba1 od numeru próbki - dodana srednia')
draw_sample_value_plot((T2_proba1), 'Zależność T2_proba1 od numeru próbki - dodana srednia')
draw_sample_value_plot((T1_proba2), 'Zależność T1_proba2 od numeru próbki - dodana srednia')
draw_sample_value_plot((T2_proba2), 'Zależność T2_proba2 od numeru próbki - dodana srednia')
draw_sample_value_plot((T1_proba3), 'Zależność T1_proba3 od numeru próbki - dodana srednia')
draw_sample_value_plot((T2_proba3), 'Zależność T2_proba3 od numeru próbki - dodana srednia')
...
draw_sample_value_plot_cast((T2_proba2), 'Zależność T2_proba2 od numeru próbki - wprowadzamy srednia - Fragment',9800,9999)
